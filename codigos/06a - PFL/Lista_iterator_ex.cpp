...
int main(){
	...
	//II) informar por onde o iterator vai come�ar a contar
	it = ex.begin(); 
	//ou it= ex.end(); se for come�ar a contar por baixo
	
	//III) definir quantas casas o iterator vai andar
	advance(it,5); 
	//o interator "it" avan�ar� 5 casas
	
	
	//IV.I)Insert: qual valor o iterator ir� inserir
	
	ex.insert(it,0);
	//o valor a ser inserido na posi��o 5 ser� 0
